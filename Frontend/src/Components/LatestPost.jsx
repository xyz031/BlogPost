...
{ (res==0)?(<div class="container text-white d-flex justify-content-center">
        ...
        {blogs && blogs.map((elem) => {
            return (
                <div className="col-md-4 mb-4" key={elem._id}>
                    <div className="card border" style={{ borderWidth: "2px", backgroundColor: "#2b2b2b", borderRadius: "10px", overflow: "hidden" }}>
                        <img 
